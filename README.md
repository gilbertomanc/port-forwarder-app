...
| **Panel web (10.5)** | Dashboard HTML en `127.0.0.1:8790` + API JSON `/api/v1`, token opcional, uptime de túneles |
...
port-forwarder web start                       # dashboard en http://127.0.0.1:8790
...
> Si automatizas con curl, añade `-H "Origin: http://127.0.0.1:8790"`. El token se
